...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post titles_url, params: { title: { Emp_No: @title.Emp_No, from_date: @title.from_date, title: @title.title, to_date: @title.to_date } }
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { Emp_No: @title.Emp_No, from_date: @title.from_date, title: @title.title, to_date: @title.to_date } }
